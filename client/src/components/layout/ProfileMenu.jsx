...
export default function ProfileMenu({ onClose, onSelectTab }) {
  return (
    <>
      ...
      <div className="absolute right-0 mt-2 w-64 bg-white rounded-2xl shadow-elevated border border-slate-200 py-2 z-50 animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="px-4 py-3 border-b border-slate-100">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-slate-500 truncate">alex@vocalis.ai</p>
            </div>
          </div>
          <div className="mt-2.5 flex items-center gap-1.5 px-2 py-1 bg-brand-50 rounded-lg text-brand-700 text-[11px] font-medium">
        ...
        {/* Log Out Placeholder */}
        <div className="p-1 pt-1 border-t border-slate-100 mt-1">
          <button
            type="button"
            onClick={() => {
