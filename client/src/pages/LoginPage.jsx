  ...
  return (
    <AuthHeroPanel>
      ...
      <div className="w-full max-w-[420px] my-auto animate-auth-card relative z-10">
        <div className="bg-white/95 backdrop-blur-md rounded-2xl border border-slate-200/90 p-5 sm:p-7 shadow-card">
          {/* Branding Header */}
          <div className="mb-4 sm:mb-5 text-left">
            <span className="font-display font-bold text-xs tracking-widest uppercase text-brand-600">
              SpeechEngine
            </span>
            <h1 className="font-display text-xl sm:text-2xl font-bold tracking-tight text-slate-900 mt-1">
              Welcome back
            </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5" noValidate>
            ...
            {errorMessage && (
              <div
                role="alert"
                className="flex items-start gap-2 p-2.5 rounded-xl border border-rose-200 bg-rose-50 text-rose-700 text-xs font-medium animate-in fade-in duration-150"
              >
